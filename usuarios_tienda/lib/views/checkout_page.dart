  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    Container(
                       ...
                       SizedBox(
                            ...
                            SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: "Introduzca el cupón para obtener un descuento adicional",
                            ...
                            TextButton(
                                onPressed: () async {
                                  ...
                                  if (querySnapshot.docs.isNotEmpty) {
                                    ...
                                    discountText =
                                        "Un descuento de $percent% ha sido aplicado.";
                                    discountCalculator(
                                        percent, cartData.totalCost);
                                  } else {
                                    print('No discount code found');
                                    discountText = "Código de descuento no disponible";
                                  }
                                  setState(() {});
                                },
                                child: Text("Aplicar"))
                        ...
                        SizedBox(
                          ...
                          Text(
                          "Cantidad total de productos: ${cartData.totalQuantity}",
                          style: TextStyle(
                            fontSize: 16,
                          ),
                        ),
                        ...
                        Divider(),
                        Text(
                          "Descuento extra: - \$ $discount",
                          style: TextStyle(fontSize: 16),
                        ),
                        Divider(),
                        Text(
                          "Total a pagar: \$ ${cartData.totalCost - discount}",
                          style: TextStyle(
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(child: Text("Proceder a pagar"), onPressed: ()async{
          final user = Provider.of<UserProvider>(context, listen: false);
            if (user.address == "" ||
                user.phone == "" ||
                user.name == "" ||
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text("Por favor, rellene los datos de entrega.")));
              return;
            }
