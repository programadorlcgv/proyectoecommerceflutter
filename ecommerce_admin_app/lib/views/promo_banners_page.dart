    ...
    return Scaffold(
      ...
      builder: (context,snapshot){
        if(snapshot.hasData){
            ...
            if(promos.isEmpty){
              return Center(child: Text("No se encontraron ${_isPromo?"Promos":"Banners"}"),);
            }
        ...
        AlertDialog(
          title: Text("¿Que quiere hacer?"),
          content: Text("Eliminar la acción no se puede deshacer"),
          actions: [
            TextButton(onPressed: (){
              Navigator.pop(context);
              showDialog(context: context, builder: (context)=>
              AdditionalConfirm(contentText: "¿Estás seguro de que quieres eliminar esto?", onYes: (){
